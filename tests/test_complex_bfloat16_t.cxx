...
TEST(complex_bfloat16_t, comparison_operators)
{
  gt::complex_bfloat16_t a{7.0, -2.0};
  gt::complex_bfloat16_t b{6.0, -3.0};
  gt::complex_bfloat16_t c{7.0, -3.0};
  gt::complex_bfloat16_t d{6.0, -2.0};
  ...
  gt::complex_bfloat16_t e{3.0, 0.0};
  gt::complex_bfloat16_t f{3.0, 1.0};
  gt::bfloat16_t s{3.0};
  gt::bfloat16_t t{4.0};
...
TEST(complex_bfloat16_t, constructors)
{
  gt::complex_bfloat16_t a{7.0, -2.0};
  gt::complex_bfloat16_t b{a};
  gt::complex<float> c{7.0, -2.0};
  gt::complex_bfloat16_t d{c};

  EXPECT_EQ(a, b);
  EXPECT_EQ(a, d);
}

TEST(complex_bfloat16_t, assignment)
{
  gt::complex_bfloat16_t a{7.0, -2.0};
  gt::complex_bfloat16_t b{0.0, 0.0};
  gt::complex_bfloat16_t c{3.0, 0.0};
  gt::bfloat16_t x{3.0};
  gt::complex_bfloat16_t e{2.0, 1.0};
...
TEST(complex_bfloat16_t, getter_setter)
{
  const gt::complex_bfloat16_t a{7.0, -2.0};
  gt::complex_bfloat16_t b;
...
TEST(complex_bfloat16_t, update_operators)
{
  gt::complex_bfloat16_t a{5.0, -3.0};
  gt::complex_bfloat16_t b{-2.0, 2.0};
  gt::complex<float> f{-2.0, 2.0};
  gt::complex_bfloat16_t ref;
  gt::bfloat16_t x{3.0};

  a += b;
  ref = gt::complex_bfloat16_t{3.0, -1.0};
  EXPECT_EQ(a, ref);

  a += x;
  ref = gt::complex_bfloat16_t{6.0, -1.0};
  EXPECT_EQ(a, ref);

  a -= b;
  ref = gt::complex_bfloat16_t{8.0, -3.0};
  EXPECT_EQ(a, ref);

  a -= x;
  ref = gt::complex_bfloat16_t{5.0, -3.0};
  EXPECT_EQ(a, ref);

  a *= b;
  ref = gt::complex_bfloat16_t{-4.0, 16.0};
  EXPECT_EQ(a, ref);

  a *= x;
  ref = gt::complex_bfloat16_t{-12.0, 48.0};
  EXPECT_EQ(a, ref);
...
TEST(complex_bfloat16_t, values)
{
  gt::complex_bfloat16_t a{4.0, -3.0};

  gt::bfloat16_t a_real{4.0};
  gt::bfloat16_t a_imag{-3.0};
  gt::bfloat16_t a_abs{5.0};
  gt::bfloat16_t a_norm{25.0};
  gt::complex_bfloat16_t a_conj{4.0, +3.0};
...
TEST(complex_bfloat16_t, binary_arithmetic_operators)
{
  gt::complex_bfloat16_t a{4.0, -4.0};
  gt::complex_bfloat16_t b{-2.0, 2.0};
  gt::bfloat16_t x{8.0};
  gt::complex_bfloat16_t c;
  gt::complex_bfloat16_t ref;

  c = a + b;
  ref = gt::complex_bfloat16_t{2.0, -2.0};
  EXPECT_EQ(c, ref);
  c = a + x;
  ref = gt::complex_bfloat16_t{12.0, -4.0};
  EXPECT_EQ(c, ref);
  c = x + a;
  EXPECT_EQ(c, ref);

  c = a - b;
  ref = gt::complex_bfloat16_t{6.0, -6.0};
  EXPECT_EQ(c, ref);
  c = a - x;
  ref = gt::complex_bfloat16_t{-4.0, -4.0};
  EXPECT_EQ(c, ref);
  c = x - a;
  ref = gt::complex_bfloat16_t{4.0, 4.0};
  EXPECT_EQ(c, ref);
  ...
  c = a * b;
  ref = gt::complex_bfloat16_t{0.0, 16.0};
  EXPECT_EQ(c, ref);
  c = a * x;
  ref = gt::complex_bfloat16_t{32.0, -32.0};
  EXPECT_EQ(c, ref);
  c = x * a;
  EXPECT_EQ(c, ref);

  c = a / b;
  ref = gt::complex_bfloat16_t{-2.0, 0.0};
  EXPECT_EQ(c, ref); // exact because b chosen s.t. norm(b) = 8
  c = a / x;
  ref = gt::complex_bfloat16_t{0.5, -0.5};
  EXPECT_EQ(c, ref);
  ref = gt::complex_bfloat16_t{1.0, 1.0};
  c = x / a;
  EXPECT_EQ(c, ref); // exact because a chosen s.t. norm(a) = 32
}

TEST(complex_bfloat16_t, unary_arithmetic_operators)
{
  gt::complex_bfloat16_t a{4.0, -5.0};
  gt::complex_bfloat16_t b{-4.0, 5.0};
  gt::complex_bfloat16_t c;
...
TEST(complex_bfloat16_t, iostream)
{
  std::istringstream is("(1.125, -2.5)");
  std::ostringstream os;
  gt::complex_bfloat16_t a{1.125, -2.5};
  gt::complex_bfloat16_t b;
...
TEST(complex_bfloat16_t, device_complex_ops)
{
  using T = gt::complex_bfloat16_t;
...
TEST(complex_bfloat16_t, device_bfloat16_t_multiply)
{
  using T = gt::bfloat16_t;
...
TEST(complex_bfloat16_t, device_complex_multiply)
{
  using T = gt::complex_bfloat16_t;
  auto I = T{0., 1.0};
  gt::gtensor<T, 2> h_a(gt::shape(3, 2));
...
// are called unnecessarily (other than __unititialized_fill which is
// difficult to avoid without ugly hacks).
TEST(complex_bfloat16_t, device_eval)
{
  using T = gt::complex_bfloat16_t;
  auto I = T{0., 1.0};
  gt::gtensor<T, 2> h_a(gt::shape(3, 2));
...
__global__ void kernel_norm(
  gt::gtensor_span_device<gt::complex_bfloat16_t, 1> d_in,
  gt::gtensor_span_device<gt::bfloat16_t, 1> d_out)
{
  int i = threadIdx.x;
  if (i < d_in.shape(0)) {
...
__global__ void kernel_conj(
  gt::gtensor_span_device<gt::complex_bfloat16_t, 1> d_in,
  gt::gtensor_span_device<gt::complex_bfloat16_t, 1> d_out)
{
  int i = threadIdx.x;
  if (i < d_in.shape(0)) {
...
TEST(complex_bfloat16_t, device_norm)
{
  const int N = 6;
  using T = gt::complex_bfloat16_t;
  auto I = T{0., 1.0};
  gt::gtensor<T, 1> h_a(gt::shape(N));
  gt::gtensor<gt::bfloat16_t, 1> h_norm(h_a.shape());

  gt::gtensor_device<T, 1> d_a(h_a.shape());
  gt::gtensor_device<gt::bfloat16_t, 1> d_norm(d_a.shape());

  for (int i = 0; i < N; i++) {
    h_a(i) = T{1., static_cast<gt::bfloat16_t>(i)};
  }
...
TEST(complex_bfloat16_t, device_conj)
{
  const int N = 6;
  using T = gt::complex_bfloat16_t;
  auto I = T{0., 1.0};
...
TEST(complex_bfloat16_t, device_abs_real)
{
  using T = gt::bfloat16_t;
...
TEST(complex_bfloat16_t, device_abs)
{
  using R = gt::bfloat16_t;
  using T = gt::complex_bfloat16_t;
  ...
  gt::copy(res, h_res);
  // here, truncation and rounding errors cancel for bfloat16
