...
struct assigner<2, space::device>
{
  ...
  static void run(E1& lhs, const E2& rhs)
  {
    ...
    cudaSyncIfEnabled();
    kernel_assign_2<<<numBlocks, numThreads>>>(lhs.to_kernel(),
                                               rhs.to_kernel());
    cudaSyncIfEnabled();
  }
};
...
struct assigner<4, space::device>
{
  ...
  static void run(E1& lhs, const E2& rhs)
  {
    ...
    cudaSyncIfEnabled();
    // std::cout << "rhs " << typeid(rhs.to_kernel()).name() << "\n";
    kernel_assign_4<<<numBlocks, numThreads>>>(lhs.to_kernel(),
                                               rhs.to_kernel());
    cudaSyncIfEnabled();
  }
};
...
struct assigner<5, space::device>
{
  ...
  static void run(E1& lhs, const E2& rhs)
  {
    ...
    cudaSyncIfEnabled();
    // std::cout << "rhs " << typeid(rhs.to_kernel()).name() << "\n";
    kernel_assign_5<<<numBlocks, numThreads>>>(lhs.to_kernel(),
                                               rhs.to_kernel());
    cudaSyncIfEnabled();
  }
};
...
struct assigner<6, space::device>
{
  ...
  static void run(E1& lhs, const E2& rhs)
  {
    ...
    cudaSyncIfEnabled();
    // std::cout << "rhs " << typeid(rhs.to_kernel()).name() << "\n";
    kernel_assign_6<<<numBlocks, numThreads>>>(lhs.to_kernel(),
                                               rhs.to_kernel());
    cudaSyncIfEnabled();
  }
};
