...
{
  gt::backend::device_copy_hh<uint8_t>((uint8_t*)src, (uint8_t*)dst, bytes);
}

void gt_backend_memcpy_dd(void* dst, const void* src, size_t bytes)
{
  gt::backend::device_copy_dd<uint8_t>((uint8_t*)src, (uint8_t*)dst, bytes);
}

void gt_backend_memcpy_dh(void* dst, const void* src, size_t bytes)
{
  gt::backend::device_copy_dh<uint8_t>((uint8_t*)src, (uint8_t*)dst, bytes);
}

void gt_backend_memcpy_hd(void* dst, const void* src, size_t bytes)
{
  gt::backend::device_copy_hd<uint8_t>((uint8_t*)src, (uint8_t*)dst, bytes);
}
